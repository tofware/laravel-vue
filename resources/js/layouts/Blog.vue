    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/home" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="https://www.freepnglogos.com/uploads/sport-png/datei-sport-svg-wikipedia-3.png" class="h-8"
                     alt="Sport Logo"/>
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul v-if="categories && categories.data && categories.data.length > 0"
                    class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li v-for="category in categories.data" :key="category.id">
                        <router-link :to="{ name: 'categories.show', params: { name: category.name } }"
